    ...
    <div class="row">
        <div class="span12">
            <ul class="breadcrumb">
              ...
              <li class="active"><b>Message Template</b></li>
              <a href="/editor" class="pull-right">Go to Editor</a>
            </ul>           
        </div>
    </div>
</div>
...
<div class="container"> 
    <div class="row">       
        <div class="span12">
            <h1>Select a Message Template
                <button id="btnCreateMessageTemplate" name="btnCreateMessageTemplate" class="btn btn-primary pull-right"> <i class="icon-plus icon-white"></i> Create an new message template</button>                                  
            </h1>   
            <div class="container">                         
