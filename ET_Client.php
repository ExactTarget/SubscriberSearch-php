...
class ET_Client extends SoapClient {
    ...
    function __construct($getWSDL = false, $params = null) {    
        ...
        parent::__construct("cache/ExactTargetWSDL.xml", array('trace'=>1, 'exceptions'=>0));
    ...
    function CreateWSDL($wsdlLoc) {
        ...
        try{
            ...
            if (file_exists("cache/ExactTargetWSDL.xml")){
                $localTS = filemtime("cache/ExactTargetWSDL.xml");
                if ($remoteTS <= $localTS) 
                {
                    $getNewWSDL = false;
                }       
            ...
            if ($getNewWSDL){
                ...
                file_put_contents("cache/ExactTargetWSDL.xml", $newWSDL);
            }   
        }
