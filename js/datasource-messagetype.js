var MessageTypeDataSource = function (options) {
	this._formatter = options.formatter;
	this._columns = options.columns;
};

MessageTypeDataSource.prototype = {	
	columns: function () {
	...
	data: function (options, callback) {
		...
		var url = 'https://www.exacttargetapis.com/guide/v1/messageTemplates/f:@all?access_token=' + token;
		var self = this;	
